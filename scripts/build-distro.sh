...
echo "==> Build PHU360 Reporting module (pihreporting omod)"
...
echo "    pihreporting omod        : $([ -f "$ROOT_DIR/openmrs-image/pihreporting-1.0.0-SNAPSHOT.omod" ] && echo present || echo MISSING)"
